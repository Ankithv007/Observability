...
# 🏠 Architecture
![Architecture](https://github.com/iam-veeramalla/observability-zero-to-hero/blob/main/day-5/images/architecture.gif)
...
```
### 9) go day4 and run the service to conncect each other (first you should in day5)
```bash
cd ../day-4
kubectl create ns dev
kubectl get pod -n dev
kubectl logs <svc name> -n dev
kubectl get pod -n logging
kubectl logs <svc name> -n logging    
``` 
## ✅ Conclusion
